...
c       save these so they can be output in event output (lbs) 
c       convert from kg to lbs        
        tgsd(1,ielmt) = clout(ipond) / 0.4536
        tgsd(2,ielmt) = slout(ipond) / 0.4536
        tgsd(3,ielmt) = saout(ipond) / 0.4536
        tgsd(4,ielmt) = laout(ipond) / 0.4536
        tgsd(5,ielmt) = sdout(ipond) / 0.4536
c
