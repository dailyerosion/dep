...
c
     ...
     1    excap, reyn, shield, smdrat, smdrqt, t, vstar, t4
...
c
      do 20 k = 1, cnpart
c
c       check for qs values getting very small to prevent underflow
        if (qs(k).lt.1.0e-31) qs(k) = 1.0e-31
