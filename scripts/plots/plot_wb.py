...
def main(argv):
    ...
    for doy in tqdm(range(1, 365)):
        ...
        myax = ax[0, 0]
        sns.distplot(
            wb['sw1'], hist=False, color="g", ax=myax,
            rug=True)
        ...
        myax = ax[0, 1]
        sns.distplot(
            wb['sw1_percent'], hist=False, color="g", ax=myax,
            rug=True)
        ...
        myax = ax[1, 0]
        sns.distplot(
            wb['sw2'], hist=False, color="g", ax=myax,
            rug=True)
        ...
        myax = ax[1, 1]
        sns.distplot(
            wb['sw2_percent'], hist=False, color="g", ax=myax,
            rug=True)
        ...
        myax = ax[2, 0]
        sns.distplot(
            wb['sw'], hist=False, color="g", ax=myax,
            rug=True)
        ...
        myax = ax[2, 1]
        sns.distplot(
            wb['sw_percent'], hist=False, color="g", ax=myax,
            rug=True)
