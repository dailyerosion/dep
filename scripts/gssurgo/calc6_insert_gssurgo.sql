...
SELECT 2024, mukey::int, compname, kwfact::real, hydrogroup
...
with data as (
    ...
    gssurgo24.dep_soilfractions)

update public.gssurgo g SET
plastic_limit = 14.22 + 0.005 * clay * clay + 3.63 * om - 0.048 * clay * om
from data d where d.rank = 1 and d.mukey::int = g.mukey and g.fiscal_year = 2024;
